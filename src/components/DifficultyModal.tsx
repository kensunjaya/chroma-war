...
const DifficultyModal: React.FC<ModalProps> = ({setState, setDifficulty, difficulty}) => {
  ...
  const cardCSS = "outline-2 w-26 lg:w-60 h-auto outline-fifth cursor-pointer rounded-xl p-2 lg:p-5 flex flex-col items-center lg:justify-center space-y-2 md:space-y-3 lg:space-y-4 xl:space-y-5";
  ...
  return (  
    <div className="fixed inset-0 backdrop-opacity-80 backdrop-blur-lg backdrop-brightness-40 font-primary overflow-y-auto h-full w-full flex items-center justify-center z-999 p-8" onClick={() => difficulty !== 0 && handleClose()}>
      <motion.div 
      ...
      >
        ...
        <div className="flex flex-row py-3 text-sm md:text-md lg:text-lg space-x-3 lg:space-x-5">
          ...
          >
            ...
            <div className="text-xs md:text-sm lg:text-lg text-center mb-auto">{"Beginner friendly. The AI makes simple moves."}</div>
          </motion.button>
          <motion.button 
          ...
          >
            ...
            <div className="text-xs md:text-sm lg:text-lg text-center mb-auto">{"A balanced challenge. The AI thinks a few moves ahead."}</div>
          </motion.button>
          <motion.button 
          ...
          >
            ...
            <div className="text-xs md:text-sm lg:text-lg text-center mb-auto">{"For experts. The AI plays optimally."}</div>
          </motion.button>
        </div>
        {
